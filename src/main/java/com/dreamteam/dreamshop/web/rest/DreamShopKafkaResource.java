...
@RestController
@RequestMapping("/api/dream-shop-kafka")
public class DreamShopKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DreamShopKafkaResource.class);
    ...
    public DreamShopKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
